  ...
  return (
    <section className="mt-10">
      ...
      <div className="mt-4 divide-y divide-gray-medium/60 rounded-xl bg-white shadow-md ring-1 ring-gray-medium/60">
        {items.map((item, i) => (
          <details key={i} className="group p-5 open:bg-cream-light/60">
            ...
            <p className="mt-3 font-body text-[16px] leading-7 text-gray-dark/85">
              {item.a}
            </p>
          </details>
        ))}
  ...
  return (
    <div className="pattern-light">
      <div className="container-shell py-16">
        ...
        <Section title="ABOUT GRWTEE" items={about} />
